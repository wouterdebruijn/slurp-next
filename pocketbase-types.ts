...
export type PlayersViewRecord<Tgiveable = unknown, Treceived = unknown, Ttaken = unknown> = {
	created: IsoAutoDateString
...
export type PlayersViewResponse<Tgiveable = unknown, Treceived = unknown, Ttaken = unknown, Texpand = unknown> = Required<PlayersViewRecord<Tgiveable, Treceived, Ttaken>> & BaseSystemFields<Texpand>
